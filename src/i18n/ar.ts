export const ar = {
    ...
    about: {
        ...
        reason3Desc: 'شحن بحري مؤمن وسريع من الصين وكوريا للجزائر',
    ...
    process: {
        ...
        step4Desc: 'شحن السيارة عبر البحر من الصين أو كوريا (25-35 يوم) مع إمكانية تتبع الشحنة.',
    ...
    cars: {
        ...
        heroSubtitle: 'أفضل السيارات الصينية والكورية الجديدة والمستعملة بأسعار منافسة',
        allCars: 'الكل',
        city: 'سيارات المدينة',
        suv: 'SUV',
        sedan: 'سيدان',
    ...
    footer: {
        description: 'وحيد أوتو - شريكك الموثوق لاستيراد السيارات الجديدة والمستعملة من الصين وكوريا إلى الجزائر. نقدم أفضل الأسعار مع ضمان الجودة والدعم الكامل.',
